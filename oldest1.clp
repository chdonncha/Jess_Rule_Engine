...
(defrule oldest-male-rule
    ...
    (person (name ?n) (age ?a2) (gender Male) )
    =>

    ; Using an if compare the ages against each other fo find the oldest
    ; if the age is less than the one it's comparing to then retract it 
    ; and proceed to the next age
